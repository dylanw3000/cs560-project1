...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Plots Widgets"))
    {
        ...
        // FIXME: This is rather awkward because current plot API only pass in floorindices.
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        // A typical application wanting coarse clipping and filtering may want to pre-compute an array of floorindices
